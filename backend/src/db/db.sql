...
CREATE TABLE users (
    ...
    password_hash VARCHAR(255) NOT NULL, -- Empty for Firebase users
...
CREATE TABLE edges (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    source_id TEXT NOT NULL, -- Can be Firebase UID or UUID
    target_id TEXT NOT NULL, -- Can be Firebase UID or UUID  
...
CREATE TABLE comments (
    ...
    node_id TEXT, -- Can be Firebase UID or UUID
...
CREATE OR REPLACE FUNCTION get_skill_recommendations(
    user_id_param TEXT, -- Firebase UID
